...
public class ReportAnError {
    ...
    @Test
    public void testReportAnError() throws Exception {
        ...
        driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Сообщить об ошибке'])[1]/preceding::span[3]")).click();
    }
