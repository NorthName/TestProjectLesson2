...
public class CheckThePicture {
    ...
    @Test
    public void testCheckThePicture() throws Exception {
        ...
        driver.findElement(By.xpath("//img[@alt='Цветки лилии кудреватой (Lilium martagon)']")).click();
    }
